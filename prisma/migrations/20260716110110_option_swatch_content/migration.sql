...
CREATE TABLE "new_ShopSetting" (
    ...
    "optionContents" TEXT NOT NULL DEFAULT '{}',
...
INSERT INTO "new_ShopSetting" ("addToCartLabel", "optionStyles", "shop", "showAddToCart", "showAvailability", "showPrice", "showQuantity", "themeColor", "updatedAt", "widgetLayout") SELECT "addToCartLabel", "optionStyles", "shop", "showAddToCart", "showAvailability", "showPrice", "showQuantity", "themeColor", "updatedAt", "widgetLayout" FROM "ShopSetting";
